...
var Icon$J = function (props) {
    return (React__default['default'].createElement(Svg, { viewBox: "0 0 24 24", width: "24px", color: "text", xmlns: "http://www.w3.org/2000/svg", className: "sc-bdvvaa hjJvDZ" },
        ...
        React__default['default'].createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M11 15C11 17.7614 8.76142 20 6 20C3.23858 20 1 17.7614 1 15C1 12.2386 3.23858 10 6 10C8.76142 10 11 12.2386 11 15ZM9 15C9 16.6569 7.65685 18 6 18C4.34315 18 3 16.6569 3 15C3 13.3431 4.34315 12 6 12C7.65685 12 9 13.3431 9 15Z" }),
        React__default['default'].createElement("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M19.5 12.97C17.57 12.97 16 14.54 16 16.47C16 18.4 17.57 19.97 19.5 19.97C21.43 19.97 23 18.4 23 16.47C23 14.54 21.43 12.97 19.5 12.97ZM19.5 17.97C18.67 17.97 18 17.3 18 16.47C18 15.64 18.67 14.97 19.5 14.97C20.33 14.97 21 15.64 21 16.47C21 17.3 20.33 17.97 19.5 17.97Z" }),
...
var Icon$_ = function (props) {
    return (React__default['default'].createElement(Svg, { viewBox: "0 0 28 28", width: "24px", color: "text", xmlns: "http://www.w3.org/2000/svg", className: "sc-bdvvaa hjJvDZ" },
...
var Icon$15 = function (props) {
    return (React__default['default'].createElement(Svg, { viewBox: "0 0 27 27", width: "24px", color: "text", xmlns: "http://www.w3.org/2000/svg", className: "sc-bdvvaa hjJvDZ" },
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            React__default['default'].createElement(Flex, null, cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: priceLinkTree, target: "_blank" },
                React__default['default'].createElement(Icon$w, { width: "24px", mr: "8px" }),
                React__default['default'].createElement(Text, { bold: true, style: { color: '#C8A2C8' } }, "$" + cakePriceUsd.toFixed(3)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }))),
            React__default['default'].createElement(Flex, null, socials.map(function (social, index) {
                ...
                if (social.items) {
                    return (React__default['default'].createElement(Dropdown, { key: social.label, position: "top-right", target: React__default['default'].createElement(Icon, __assign({}, iconProps, { mr: mr })) }, social.items.map(function (item) { return (React__default['default'].createElement(Link, { external: true, key: item.label, href: item.href, "aria-label": item.label, style: { color: '#C8A2C8' } }, item.label)); })));
                }
                return (React__default['default'].createElement(Link, { external: true, key: social.label, href: social.href, "aria-label": social.label, mr: mr },
                    React__default['default'].createElement(Icon, __assign({}, iconProps))));
            })),
            React__default['default'].createElement(Dropdown, { position: "top", target: React__default['default'].createElement(Button, { variant: "text", pr: "6px", pl: "6px", startIcon: React__default['default'].createElement(LanguageIcon, { color: "textSubtle", width: "24px" }) },
                    React__default['default'].createElement(Text, { style: { color: '#C8A2C8' } }, currentLang === null || currentLang === void 0 ? void 0 : currentLang.toUpperCase())) }, langs.map(function (lang) { return (React__default['default'].createElement(MenuButton, { key: lang.code, fullWidth: true, onClick: function () { return setLang(lang); }, 
                // Safari fix
